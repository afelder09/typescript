...
},{}],"src/models/ApiSyn.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attributes(attrs), new ApiSyn_1.ApiSync(rootUrl), new Eventing_1.Eventing());
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./ApiSyn":"src/models/ApiSyn.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
users.fetch();
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"../../../../.nvm/versions/node/v10.0.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../.nvm/versions/node/v10.0.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
