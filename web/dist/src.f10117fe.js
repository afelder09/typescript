...
function () {
  function User(data) {
    ...
    this.sync = new Sync_1.Sync('http://localhost:1234/users');
...
exports.User = User;
},{"./Eventing":"models/Eventing.ts","./Sync":"models/Sync.ts","./Attributes":"models/Attributes.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
